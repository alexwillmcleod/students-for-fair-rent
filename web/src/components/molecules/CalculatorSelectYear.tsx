...
export default function SelectYear(props: SelectYearProps) {
  const handleSelectYear = (e: any) => {
    props.setIsFirstYear(e.target.value == 'first');
  };

  return (
    <div class="flex flex-col justify-center items-center gap-8">
      <p class="font-bold text-5xl font-display">
        Will 2024 be your First Year?
      </p>
      <div class="flex flex-col gap-4">
        <span class="flex flex-row gap-4 items-center">
          ...
          <input
            ...
            name="year"
            value="first"
            checked={props.isFirstYear == true}
          />
        </span>
        <span class="flex flex-row gap-4 items-center">
          <label
            class="text-xl"
            for="second-year-plus"
          >
            No
          </label>
          <input
            ...
            name="year"
            value="later"
            checked={props.isFirstYear == false}
          />
        </span>
      </div>
    </div>
